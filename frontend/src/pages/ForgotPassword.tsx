        ...
        <div className="text-center mb-12">
          <div className="inline-block relative">
            ...
            <div className="flex items-center justify-center gap-4 mt-2">
              ...
              <span className="font-headline text-xl tracking-[0.3em] text-on-surface-variant font-bold uppercase">Forgotten Ritual</span>
          ...
          {sent ? (
            <div className="text-center space-y-6 relative z-10">
              ...
              <p className="text-on-surface font-body text-base leading-relaxed">
                If an account exists for <span className="text-primary font-bold">{email}</span>,
                a reset link has been sent.
              </p>
              <p className="text-on-surface-variant text-sm">
                Check your inbox — or the server console if you're in dev mode.
              </p>
            </div>
          ) : (
